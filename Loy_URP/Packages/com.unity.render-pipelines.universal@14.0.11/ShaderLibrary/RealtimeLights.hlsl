...
//                      Light Abstraction                                    //
///////////////////////////////////////////////////////////////////////////////
float4 _MainLightRealColor;
float4 _MainLightRealDir; //w代表是否是开启自定义主光
Light GetMainLight()
{
    Light light;
    light.direction = half3(_MainLightPosition.xyz);
#if !_UIMODEL_ON
    if(_MainLightRealDir.w == 1.0f)
        light.direction = half3(_MainLightRealDir.xyz);
#endif
#if USE_FORWARD_PLUS
...
#if !_UIMODEL_ON
    if(_MainLightRealDir.w == 1.0f)
        light.color = _MainLightRealColor.rgb;
#endif
