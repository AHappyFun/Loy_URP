...
#pragma warning restore 0618
        ...
        public float gaeaFxaaFixedThreshold;

        public float gaeaFxaaRelativeThreshold;

        public float gaeaFxaaSubpixelBlending;
    ...
    public static class ShaderKeywordStrings
    {
        ...
        /// <summary> Keyword used for low quality Subpixel Morphological Anti-aliasing (SMAA). </summary>
        public const string GaeaFXAALow = "FXAA_QUALITY_LOW";

        /// <summary> Keyword used for medium quality Subpixel Morphological Anti-aliasing (SMAA). </summary>
        public const string GaeaFXAAMedium = "FXAA_QUALITY_MEDIUM";

        /// <summary> Keyword used for high quality Subpixel Morphological Anti-aliasing (SMAA). </summary>
        //public const string GaeaFXAAHigh = "FXAA_QUALITY_HIGH";
        ...
        public const string GAEA_FXAA = "_GAEA_FXAA";

        public const string GAEA_RADIALBLUR = "_GAEA_RADIALBLUR";
        ...
        public const string RENDER_DEBUG = "GAEA_RENDER_DEBUG";
