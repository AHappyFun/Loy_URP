    ...
    public sealed partial class UniversalRenderPipeline : RenderPipeline
    {
        ...
        static void InitializeStackedCameraData(Camera baseCamera, UniversalAdditionalCameraData baseAdditionalCameraData, ref CameraData cameraData)
        {
            ...
            else if (baseAdditionalCameraData != null)
            {
                ...
                cameraData.gaeaFxaaFixedThreshold = baseAdditionalCameraData.gaeaFxaaFixedThreshold;
                cameraData.gaeaFxaaRelativeThreshold = baseAdditionalCameraData.gaeaFxaaRelativeThreshold;
                cameraData.gaeaFxaaSubpixelBlending = baseAdditionalCameraData.gaeaFxaaSubpixelBlending;
            }
            else
            {
                cameraData.volumeLayerMask = 1; // "Default"
