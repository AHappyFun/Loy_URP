...
namespace UnityEngine.Rendering.Universal
{
    ...
    public class UniversalAdditionalCameraData : MonoBehaviour, ISerializationCallbackReceiver, IAdditionalData
    {
        ...
        [SerializeField]public float gaeaFxaaFixedThreshold;
        [SerializeField]public float gaeaFxaaRelativeThreshold;
        [SerializeField]public float gaeaFxaaSubpixelBlending;
