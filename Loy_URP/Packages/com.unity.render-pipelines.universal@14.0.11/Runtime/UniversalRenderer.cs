...
namespace UnityEngine.Rendering.Universal
{
    ...
    public sealed partial class UniversalRenderer : ScriptableRenderer
    {
        ...
        public override void Setup(ScriptableRenderContext context, ref RenderingData renderingData)
        {
            ...
            var asset = UniversalRenderPipeline.asset;
            bool applyPostProcessing = cameraData.postProcessEnabled && m_PostProcessPasses.isCreated && asset.supportsPostProcess;

            // There's at least a camera in the camera stack that applies post-processing
            bool anyPostProcessing = renderingData.postProcessingEnabled && m_PostProcessPasses.isCreated && asset.supportsPostProcess;
