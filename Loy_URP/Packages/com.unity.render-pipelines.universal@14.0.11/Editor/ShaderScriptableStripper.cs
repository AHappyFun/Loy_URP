...
namespace UnityEditor.Rendering.Universal
{
    ...
    internal class ShaderScriptableStripper : IShaderVariantStripper, IShaderVariantStripperScope
    {
        ...
        LocalKeyword m_GAEARenderDebug;
        ...
        private void InitializeLocalShaderKeywords([DisallowNull] Shader shader)
        {
            ...
            m_GAEARenderDebug = TryGetLocalKeyword(shader, ShaderKeywordStrings.RENDER_DEBUG);
        ...
        *********************************************************/
        ...
        {
            return strippingData.stripDebugDisplayShaders && (strippingData.IsKeywordEnabled(m_DebugDisplay) || strippingData.IsKeywordEnabled(m_GAEARenderDebug));
        }
