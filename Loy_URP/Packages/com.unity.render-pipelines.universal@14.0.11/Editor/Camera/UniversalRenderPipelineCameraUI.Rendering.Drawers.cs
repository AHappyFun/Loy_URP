...
namespace UnityEditor.Rendering.Universal
{
    ...
    static partial class UniversalRenderPipelineCameraUI
    {
        public partial class Rendering
        {
                ...
                CED.Conditional(
                    ...
                    CED.Group(
                        ...
                        new[]{
                            ...
                            //CED.Conditional(
                            //    (serialized, owner) => (AntialiasingMode)serialized.antialiasing.intValue ==
                            //    AntialiasingMode.GAEAFXAA,
                            //    CED.Group(
                            //        DrawRenderingGAEAFxaaQuality
                            //    ))
                        }
                    )
                    ),
            ...
            static void DrawRenderingGAEAFxaaQuality(UniversalRenderPipelineSerializedCamera p, Editor owner)
            {
                EditorGUILayout.PropertyField(p.antialiasingQuality, Styles.antialiasingQuality);
                EditorGUILayout.Slider(p.gaeaFxaaFixedThreshold, 0.0312f, 0.0833f);
                EditorGUILayout.Slider(p.gaeaFxaaRelativeThreshold, 0.063f, 0.333f);
                EditorGUILayout.Slider(p.gaeaFxaaSubpixelBlending, 0.0f, 1.0f);
            }
