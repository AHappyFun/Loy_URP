...
//
		...
		half blur_h(Varyings input) : SV_Target
        {
            ...
            half c0 = SAMPLE_TEXTURE2D_X(_MainTex, sampler_MainTex, input.uv - half2(texelSize * 3.23076923, 0.0)).r;
            half c1 = SAMPLE_TEXTURE2D_X(_MainTex, sampler_MainTex, input.uv - half2(texelSize * 1.38461538, 0.0)).r;
            half c2 = SAMPLE_TEXTURE2D_X(_MainTex, sampler_MainTex, input.uv).rgb;  
            half c3 = SAMPLE_TEXTURE2D_X(_MainTex, sampler_MainTex, input.uv + half2(texelSize * 1.38461538, 0.0)).r;
            half c4 = SAMPLE_TEXTURE2D_X(_MainTex, sampler_MainTex, input.uv + half2(texelSize * 3.23076923, 0.0)).r;
		...
		half blur_v(Varyings input) : SV_Target
        {
            ...
            half c0 = SAMPLE_TEXTURE2D_X(_MainTex, sampler_MainTex, input.uv - half2(0.0, texelSize * 3.23076923)).r;
            half c1 = SAMPLE_TEXTURE2D_X(_MainTex, sampler_MainTex, input.uv - half2(0.0, texelSize * 1.38461538)).r;
            half c2 = SAMPLE_TEXTURE2D_X(_MainTex, sampler_MainTex, input.uv).r;  
            half c3 = SAMPLE_TEXTURE2D_X(_MainTex, sampler_MainTex, input.uv + half2(0.0, texelSize * 1.38461538)).r;
            half c4 = SAMPLE_TEXTURE2D_X(_MainTex, sampler_MainTex, input.uv + half2(0.0, texelSize * 3.23076923)).r;
