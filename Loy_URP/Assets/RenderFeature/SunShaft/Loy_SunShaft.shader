Shader "Loy/Feature/SunShaft"
{
    ...
    HLSLINCLUDE
        ...
        float4 SunShaftParams[3];
        #define _BloomThreshold SunShaftParams[0].x
        #define _BloomScale SunShaftParams[0].y
        #define _BloomMaxBrightness SunShaftParams[0].z
        #define _MaskDepth SunShaftParams[0].w
        #define _BlurCenter SunShaftParams[1].xy
        #define _BlurRadius SunShaftParams[1].z
        #define _BlurSamples SunShaftParams[1].w
        #define _Color SunShaftParams[2].xyz
        #define _ScreenFade SunShaftParams[2].w
